...
export function registerWorker(registry, workerId, metadata = {}) {
    return registry.register(workerId, metadata);
}
export function recordHeartbeat(registry, workerId) {
...
export function cancelBuildJob(registry, jobId, reason) {
    return registry.cancelJob(jobId, reason);
}
export function isBuildJobCancelled(registry, jobId) {
    return registry.isCancelled(jobId);
}
async function handleJobExecution(channel, message, registry, workerId, job) {
...
//# sourceMappingURL=build-consumer.js.map