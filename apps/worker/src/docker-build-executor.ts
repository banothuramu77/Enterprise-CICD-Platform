...
export async function executeDockerBuild(request: DockerBuildRequest, deps: DockerBuildExecutorDependencies = {}): Promise<DockerBuildResult> {
  ...
  const result = await new Promise<DockerBuildResult>((resolve) => {
